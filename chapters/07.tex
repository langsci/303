...
\begin{figure}
  \captionsetup{margin=.05\linewidth}
    \begin{floatrow}
        \ffigbox{\includegraphics[width=.5\textwidth]{figures/UBAN_falseness_ff_hist.pdf}}
                {\caption{Falseness in correctly detected false friends.\label{false_hist1}}}
        \ffigbox{\includegraphics[width=.5\textwidth]{figures/UBAN_falseness_notff_hist.pdf}}
